...
export const hizmetler: Hizmet[] = [
  ...
  },
  {
    ...
    sss: [
      ...
      { s: "Isı pompası yıllık nasıl korunur?", c: "Yılda bir kez dış ünite temizliği, filtre kontrolü ve soğutucu akışkan basınç ölçümü önerilir. Bu işlemler Bosch yetkili servisi tarafından yapılır. BNS Enerji yeni sistem kurulumu ve devreye alma yapar — periyodik bakım hizmeti vermez." },
    ],
  },
  {
  ...
  },
  {
    ...
    sss: [
      ...
      { s: "Klima yıllık bakım gerekli mi?", c: "Evet — yılda 1 kez filtre temizliği, gaz kontrolü ve iç ünite hijyeni önerilir. Bosch klima bakımı Bosch yetkili servisi tarafından yapılır; BNS Enerji satış ve yeni montaj süreçlerini koordine eder — periyodik bakım hizmeti vermez." },
  ...
  },
  {
    ...
    sss: [
      ...
      { s: "Kombi yıllık bakım gerekli mi?", c: "Evet — Bosch kombiler için yılda bir bakım önerilir: brülör ayarı, baca gazı analizi, emniyet ventili testi, sistem basıncı ve filtre kontrolü. Bakım Bosch yetkili servisi tarafından yapılır. BNS Enerji satış, yeni montaj ve kombi değişimi yapar — periyodik bakım hizmeti vermez." },
    ],
    karsilastirma: {
  ...
  },
  {
    ...
    sss: [
      ...
      { s: "VRF bakım sıklığı nedir?", c: "Yılda en az 1 kez profesyonel bakım önerilir: filtre temizliği, soğutucu basınç ölçümü, elektrik bağlantı kontrolü, iç ünite drenaj testi. Bosch VRF bakımı Bosch yetkili servisi tarafından yapılır. BNS Enerji satış, proje ve yeni sistem kurulumu yapar — periyodik bakım hizmeti vermez." },
